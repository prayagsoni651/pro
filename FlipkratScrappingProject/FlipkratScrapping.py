...
class FlipkratScrapper:
    ...
    def findElementByTag(self, tag_name):
        ...
        """
        try:
            element = self.driver.find_elements(By.TAG_NAME, value=tag_name)
            return element
        except Exception as e:
    ...
    def login_popup_handle(self):
        ...
        try:
            ...
            # Login popup might not always appear, so we can ignore if not found or just log it.
            print("Login popup not found or handled.")
            return False
